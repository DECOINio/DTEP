...
BOOST_AUTO_TEST_CASE(multisig_Solver1)
{
    ...
    //
    // Also tests IsMine() and EDTEPactAddress()
    //
    // Note: EDTEPactAddress for the multisignature transactions
...

    {
        ...
        CTxDestination addr;
        BOOST_CHECK(EDTEPactDestination(s, addr));
    ...
    }
    {
        ...
        int nRequired;
        BOOST_CHECK(EDTEPactDestinations(s, whichType, addrs, nRequired));
