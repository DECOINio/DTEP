...
void IncrementEDTEPaNonce(CBlock* pblock, CBlockIndex* pindexPrev, unsigned int& nEDTEPaNonce)
{
    // Update nEDTEPaNonce
    ...
    pblock->vtx[0].vin[0].scriptSig = (CScript() << nHeight << CBigNum(nEDTEPaNonce)) + COINBASE_FLAGS;
